...
let places =
    [   place "Выход к морю" "hsl(60,60%,20%)"
...
let items =
    [   item "ракушка" ("Повсюду разбросаны ", "ракушки", ".", Take "ракушка")
        item "дельфин" ("Ой, тут плавает ", "дельфин", ".", Talk "дельфин")
